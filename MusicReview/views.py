...
from .forms import ImageColorForm, SearchForm
...
def accent_colors_test(request):
    ctx = { "userId": 0, "accentColors": default_colors(), "searchForm": SearchForm(), "form": ImageColorForm(), "errMessages": ["This is a message", "And another message"] }
